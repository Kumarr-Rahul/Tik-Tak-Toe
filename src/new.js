...
class TTT extends React.Component {
    constructor(props){
        ...
        this.state = {
            history: [
                [null, null, null, null, null, null, null, null, null], //when no button is clicked

                      
                // [null, null, null, null, 'X', null, null, null, null],
                // [null, null, null, null, 'X', null, null, 'O', null],
                // [null, 'X', null, null, 'X', null, null, 'O', null],
                //with every click O or X are filing in 2D natrix
    ...
    handleSquareClick(i){
        ...
        currentSquares[i] = (this.state.stepNumber % 2 == 0? 'X': 'O');  //if(this.state.stepNumber % 2 == 0) {X} else {O}
    ...
    moveToStep(i){
        let oldHistory = this.state.history.slice(0, i + 1); //1 click hua to 0 and 1 state ka data rahna chaiye
